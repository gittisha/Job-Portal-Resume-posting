...
// ─────────────────────────────────────────────────────────────
// AccessTerminalLogin
// Angular / red-cyan HUD login screen, styled after the classic
// "cut-corner" cyberpunk menu look. Wire up handleSubmit to your
// Spring Boot endpoint (stub below).
// ─────────────────────────────────────────────────────────────
...
export default function AccessTerminalLogin({ onLogin }) {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      setStatus("error");
      setErrorMsg("ACCESS DENIED // CHECK CREDENTIALS");
    }
  }
      ...
      <div style={styles.center}>
        ...
        <div className="at-panel">
          <header className="at-header">
            <p className="at-eyebrow">RESTRICTED NETWORK NODE</p>
            <h1 className="at-title">ACCESS&nbsp;TERMINAL</h1>
            <div className="at-hr" />
          </header>
          ...
          <form onSubmit={handleSubmit} noValidate>
            ...
            >
              ...
              <span>{status === "authenticating" ? "AUTHENTICATING" : "CONNECT"}</span>
            </button>
            ...
            <div className="at-console" role="status" aria-live="polite">
              ...
              {status === "success" && (
                <p className="at-console-line at-console-ok">UPLINK ESTABLISHED</p>
              )}
            </div>
          </form>
...
.at-title {
  ...
  color: #ff5a5a;
//   text-shadow: 0 0 10px     rgba(253, 248, 248, 0.5);
  text-align: center;
}
.at-hr {
  margin-top: 14px;
